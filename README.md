...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sql-magic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12513&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sql-magic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sql-magic` can be installed with:

```
conda install sql-magic
```

It is possible to list all of the versions of `sql-magic` available on your platform with:
